        ...
        while ($row = mysqli_fetch_assoc($run)) {
          ...
          <tr>
            ...
            <td><a class="btn btn-danger" href="deletegenre.php?id=<?php echo $row['id']; ?>">DELETE</a>
              <!-- <a class="btn btn-outline-info" href="editgenre.php?id=<?php echo $row['id']; ?>&genrename=<? php // echo$row['genre_name']; ?>&genreid=<? php // echo$row['genreid']; ?>">EDIT</a>-->
            </td>
          </tr>
          <?php
        }
